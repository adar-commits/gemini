...
**Branch inventory across stores** (יש בסניפים / באיזה סניף יש / מלאי ברשת) — the system can check live store stock when a SKU is known. A SKU always contains a hyphen (e.g. 31503138-200290).
