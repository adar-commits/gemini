...
• Bedroom space use (only if TARGET_SPACE = חדר שינה and use unknown): "אוקיי קיבלתי, החדר משמש ביום־יום כחדר תינוקות, חדר ילדים או נוער, חדר ליחיד/זוגי, לאadם מבוגר או שימוש אחר?"
