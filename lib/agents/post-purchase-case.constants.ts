...
export const EXCHANGE_FLOW_MARKER = "קיבלתי — רוצה להחליף"
...
export const CASE_MARKERS: Record<PostPurchaseCaseKind, string> = {
  ...
  exchange_request: EXCHANGE_FLOW_MARKER,
...
export function flowMarkerFromText(text: string): PostPurchaseCaseKind | null {
  ...
  if (text.includes(EXCHANGE_FLOW_MARKER)) return "exchange_request"
