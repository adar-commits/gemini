...
לשטיחים: עד 4 ימי עסקים ממועד אישור התשלום (לא כולל שישי, שבת וחגים). הזמנות אחרי 12:00 נספרות מיום העסקים הבא.
לפופים שמגיעים ארוזים בקופסה (הרכבה עצמית): 5–8 ימי עסקים.
לפופים מוכנים, שממולאים ידנית אצלנו אחרי ההזמנה: עד 14 ימי עסקים.
